...
export const HARDWARE_PRODUCTS = [
  ...
  },
  {
    ...
    coverImage: '/images/hardware/e-table-sign.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/desk-screen.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/smart-lighting.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/smart-hvac.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/switch-control.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/sensor.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/energy-meter.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/gateway.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/smart-meeting.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/office-device.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/eink-price-tag.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/lcd-price-tag.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/cold-tag.svg',
    capabilities: ['低温场景适配'],
    scenarios: ['冷链仓储', '生鲜门店'],
    sortOrder: 140,
    published: true,
  ...
  },
  {
    ...
    coverImage: '/images/hardware/aap.svg',
  ...
  },
  {
    ...
    coverImage: '/images/hardware/eink-phone-case.svg',
    capabilities: ['墨水屏显示'],
    scenarios: ['个人消费电子'],
    sortOrder: 160,
    published: true,
  ...
  },
  {
    ...
    coverImage: '/images/hardware/eink-frame.svg',
...
export const HARDWARE_SPACE_FLOW = [
  { id: 'sense', title: '感知', desc: '传感器采集环境与设备状态', icon: 'sensors' },
  { id: 'control', title: '控制', desc: '开关、照明和空调执行联动', icon: 'tune' },
  { id: 'interact', title: '交互', desc: '中控屏、桌牌和工位屏提供操作入口', icon: 'touch_app' },
  { id: 'edge', title: '边缘', desc: '网关负责设备接入、协议转换与本地处理', icon: 'dns' },
  { id: 'platform', title: '平台', desc: '统一管理设备、数据和智能体能力', icon: 'cloud' },
]
