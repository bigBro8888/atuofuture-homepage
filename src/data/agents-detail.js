...
export const AGENT_DETAILS = {
  reception: {
    ...
    receptionPage: {
      heroTags: ['接待流程自动编排', '多系统联动执行', '全流程数据沉淀'],
      flowNodes: ['智能邀约', '到访识别', 'VIP停车', '智能派梯', '会议联动', '会中服务', '数据复盘'],
      painPoints: [
        { icon: 'hub', title: '接待信息分散', desc: '邀约、车辆、人员、会议室、餐饮、服务需求分散在不同人员和系统里。' },
        { icon: 'star_half', title: 'VIP体验不稳定', desc: '车位、派梯、前台引导、会议室准备依赖人工确认，容易漏环节。' },
        { icon: 'account_tree', title: '跨系统协同困难', desc: '停车、门禁、梯控、会议室、工单、大屏各自独立，无法形成自动化流程。' },
        { icon: 'analytics', title: '事后无法复盘', desc: '接待过程没有统一数据沉淀，难以统计效率、服务质量和资源使用情况。' },
      ],
      timeline: [
        { title: '智能邀约', desc: '自动生成访客邀请、会议议程、到访时间、车辆信息和通行权限。' },
        { title: '到访识别', desc: '访客到达后完成车牌识别、身份核验、前台通知和接待提醒。' },
        { title: 'VIP动线引导', desc: '根据访客等级自动匹配车位、派梯策略、引导路线和接待人员。' },
        { title: '会议空间联动', desc: '提前联动会议室灯光、空调、屏幕、门牌、电子桌牌和欢迎语。' },
        { title: '会中服务响应', desc: '通过屏幕、语音或服务入口发起茶水、设备、资料、会务支持等请求。' },
        { title: '离场与纪念', desc: '离场提醒、访客签退、照片或纪念内容生成、资料归档。' },
        { title: '数据复盘', desc: '自动沉淀接待记录、资源使用、服务响应、访客评价和接待报表。' },
      ],
      capabilityGrid: [
        { icon: 'draft', title: '访客邀约', desc: '自动生成邀请函、二维码、来访信息、车辆信息和通行权限。' },
        { icon: 'local_parking', title: '车辆接待', desc: '支持 VIP 车位预留、车牌识别、停车引导和到达提醒。' },
        { icon: 'door_front', title: '门禁通行', desc: '根据访客身份自动下发临时权限，实现闸机、门禁快速通行。' },
        { icon: 'elevator', title: '梯控派梯', desc: '按访客身份、目的楼层和接待等级，自动分配电梯权限和派梯策略。' },
        { icon: 'meeting_room', title: '会议联动', desc: '联动会议室设备、门牌、桌牌、屏幕、欢迎语、灯光和空调。' },
        { icon: 'assignment', title: '服务工单', desc: '茶水、设备、保洁、安保、会务支持等请求自动生成工单并流转。' },
        { icon: 'dashboard', title: '大屏展示', desc: '展示接待状态、会议状态、访客动线、空间资源和服务进度。' },
        { icon: 'query_stats', title: '数据报表', desc: '沉淀接待次数、响应时长、资源利用率、访客评价和服务质量数据。' },
      ],
      architecture: [
        { title: '感知层', desc: '访客信息、车牌、门禁、会议室状态、设备状态、服务请求。' },
        { title: '理解层', desc: '识别访客等级、会议类型、接待规则、空间资源和服务需求。' },
        { title: '编排层', desc: '自动生成接待流程，调度车位、门禁、梯控、会议室、人员和工单。' },
        { title: '执行层', desc: '联动硬件设备、消息通知、服务工单、大屏展示和数据归档。' },
      ],
      systems: ['停车', '门禁', '梯控', '会议室', '大屏', '工单', '报表'],
      useCases: [
        { title: '总部VIP接待', fit: '适合领导参观、政府来访、重要客户到访。', steps: ['预约确认', '车位预留', '专属派梯', '欢迎大屏', '会议室联动', '离场归档'] },
        { title: '展厅参观接待', fit: '适合企业展厅、产业园展厅、招商中心。', steps: ['访客预约', '到访识别', '展厅引导', '讲解安排', '资料发送', '参观复盘'] },
        { title: '大型会议接待', fit: '适合论坛、培训、发布会、内部大会。', steps: ['批量邀约', '签到核验', '分组引导', '会场联动', '会中服务', '数据统计'] },
        { title: '商务来访接待', fit: '适合日常访客、供应商、合作伙伴、面试来访。', steps: ['来访登记', '权限下发', '前台通知', '会议室预约', '服务闭环', '记录归档'] },
      ],
      before: ['靠微信群通知', '靠电话反复确认', '靠前台人工登记', '靠接待人员现场协调', '接待记录难追踪', '服务质量难复盘'],
      after: ['自动生成接待流程', '自动同步人员、车辆和会议室信息', '自动下发门禁和梯控权限', '自动联动会议室设备', '自动生成服务工单', '自动沉淀数据报表'],
      values: [
        { title: '接待效率提升', desc: '减少人工沟通、电话确认和临时协调，让接待流程自动运转。' },
        { title: '访客体验提升', desc: '从停车、入楼、乘梯到会议室，全程顺畅，减少等待和迷路。' },
        { title: '空间资源更可控', desc: '会议室、车位、设备、服务人员统一调度，提高资源利用效率。' },
        { title: '管理过程可复盘', desc: '接待过程形成数据，方便统计、追踪、优化和管理决策。' },
      ],
    },
  },
  security: {
